...
public class AuthController {
    ...
    public ResponseEntity<?> register(@RequestBody CustRegisterRequest request) {
        ...
        return responseBuilderUtil.buildResponse(registerResponse, "Registered", HttpStatus.CREATED);
    }
...
//    @PreAuthorize("hasRole('ADMIN')")
    ...
    public ResponseEntity<?> login(@RequestBody AuthRequest request) {
        ...
        return responseBuilderUtil.buildResponse(login, "Login succeess", HttpStatus.CREATED);
    }
}

...
//    private final OrderRequest orderRequest;
    ...
    public ResponseEntity<?> getAllOrders() {
        ...
        return responseBuilderUtil.buildResponse(orderResponse, "Successfully retrieve all data", HttpStatus.FOUND);
    }
    ...
    public ResponseEntity<?> getOrderDetailById(@PathVariable String id) {
        ...
        return responseBuilderUtil.buildResponse(orderDetailResponse, "Successfully retrieve data", HttpStatus.FOUND);
    }
}
